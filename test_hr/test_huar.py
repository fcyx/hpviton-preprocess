...
def get_img_agnostic(img, parse, pose_data):
    ...
    agnostic.paste(img, None, Image.fromarray(np.uint8(parse_head * 256), 'L'))
    agnostic.paste(img, None, Image.fromarray(np.uint8(parse_lower * 256), 'L'))

    return agnostic

if __name__ =="__main__":
    data_path = './test1'
    output_path = './test1/parse'
